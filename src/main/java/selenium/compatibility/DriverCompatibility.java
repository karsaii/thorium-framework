...
public class DriverCompatibility {
    public static DriverFunction<WebElement> getElementByCssSelector(String selector, String nameof) {
        return ifDriver(isNotBlank(nameof) ? nameof : "getElementByCssSelector", isNotBlank(selector), Driver.getElement(By.cssSelector(selector)), DataConstants.NULL_ELEMENT);
    }
    ...
    public static DriverFunction<WebElementList> getElementsByCssSelector(String selector) {
        return ifDriver("getElementsByCssSelector", isNotBlank(selector), Driver.getElements(By.cssSelector(selector)), DataConstants.NULL_LIST);
    }

    public static DriverFunction<WebElement> getElementById(String id) {
        return ifDriver("getElementById", isNotBlank(id), Driver.getElement(By.id(id)), DataConstants.NULL_ELEMENT);
    }

    public static DriverFunction<WebElementList> getElementsByClass(String className) {
        return ifDriver("getElementsByClass", isNotBlank(className), Driver.getElements(By.className(className)), DataConstants.NULL_LIST);
    }

    public static DriverFunction<WebElement> getElementByClass(String className) {
        return ifDriver("getElementByClass", isNotBlank(className), Driver.getElement(By.className(className)), DataConstants.NULL_ELEMENT);
    }

    public static DriverFunction<WebElement> getElementByXpath(String xpath) {
        return ifDriver("getElementByXpath", isNotBlank(xpath), Driver.getElement(By.xpath(xpath)), DataConstants.NULL_ELEMENT);
    }
}
