...
import com.github.karsaii.selenium.constants.Alternatives;
...
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.isNotNullLazyElementWaitParametersData;
import static com.github.karsaii.selenium.namespaces.WaitConditions.waitWith;
...
public interface Element {
    ...
    static DriverFunction<Boolean> click(LazyElement element) {
        return ifDriver(
            SeleniumFormatter.isNullLazyElementMessage(element),
    ...
    static <T, U> DriverFunction<U> actionWhenCore(LazyElement data, Function<LazyElement, DriverFunction<U>> action, Function<LazyElement, DriverFunction<T>> condition) {
        return ifDriver(
            "actionWhenCore",
            SeleniumFormatter.isNullLazyElementMessage(data),
