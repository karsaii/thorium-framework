...
import com.github.karsaii.selenium.constants.SeleniumInvokeConstants;
import com.github.karsaii.core.extensions.namespaces.CollectionPredicateFunctions;
...
import com.github.karsaii.selenium.abstracts.AbstractElementFunctionParameters;
import com.github.karsaii.selenium.constants.ElementFunctionConstants;
import com.github.karsaii.selenium.constants.SeleniumInvokeFunctionDefaults;
...
import com.github.karsaii.selenium.constants.FactoryConstants;
...
import com.github.karsaii.selenium.constants.MethodDefaults;
...
import com.github.karsaii.selenium.constants.DriverFunctionConstants;
import com.github.karsaii.selenium.constants.ElementFinderConstants;
import com.github.karsaii.selenium.constants.ExecuteCoreDataConstants;
import com.github.karsaii.selenium.constants.ExecuteCoreFunctionDataConstants;
...
import com.github.karsaii.selenium.constants.SeleniumMethodDefaults;
...
import com.github.karsaii.selenium.namespaces.scripter.Execute;
import com.github.karsaii.selenium.namespaces.repositories.ElementRepository;
import com.github.karsaii.selenium.namespaces.repositories.FunctionRepository;
import com.github.karsaii.selenium.namespaces.repositories.LocatorRepository;
import com.github.karsaii.selenium.namespaces.element.validators.ElementGetterValidators;
import com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities;
import com.github.karsaii.selenium.namespaces.validators.ExecuteCoreValidators;
import com.github.karsaii.selenium.namespaces.validators.InvokeCoreValidator;
import com.github.karsaii.selenium.namespaces.element.validators.WebElementValidators;
import com.github.karsaii.selenium.records.element.is.ElementConditionParameters;
import com.github.karsaii.selenium.records.element.is.ElementStringValueParameters;
...
import com.github.karsaii.selenium.records.scripter.ExecuteCoreData;
import com.github.karsaii.selenium.records.scripter.ExecuteCoreFunctionData;
import com.github.karsaii.selenium.records.ExternalElementData;
import com.github.karsaii.selenium.records.ExternalSelectorData;
import com.github.karsaii.selenium.records.GetWithData;
...
import com.github.karsaii.selenium.records.scripter.ParametersFieldDefaultsData;
...
import com.github.karsaii.selenium.records.scripter.ExecutorData;
import com.github.karsaii.selenium.records.scripter.ExecutorParametersFieldData;
import com.github.karsaii.selenium.namespaces.validators.ScriptExecutions;
...
import static com.github.karsaii.selenium.namespaces.validators.SeleniumFormatter.getElementsParametersMessage;
...
import static com.github.karsaii.selenium.namespaces.validators.SeleniumFormatter.isNullLazyDataMessage;
...
import static com.github.karsaii.selenium.namespaces.ExecutionCore.conditionalChain;
import static com.github.karsaii.selenium.namespaces.ExecutionCore.ifData;
import static com.github.karsaii.selenium.namespaces.ExecutionCore.ifDriver;
import static com.github.karsaii.selenium.namespaces.ExecutionCore.ifDriverGuardData;
import static com.github.karsaii.selenium.namespaces.ExecutionCore.validChain;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.getKeysCopy;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.getLazyLocator;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.getLocator;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.isNotNullLazyData;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.isNotNullLazyElement;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.isNotNullWebElement;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.isNullLazyData;
import static com.github.karsaii.selenium.namespaces.utilities.SeleniumUtilities.isNullWebElement;
...
public interface Driver {
    ...
    static Data<Integer> getWindowHandleAmountData(Data<StringSet> data) {
        return getAmount("getWindowHandleAmount", data, SeleniumFormatter::getWindowHandlesMessage, BasicPredicateFunctions::isPositiveNonZero);
    }

    static Data<Integer> getCountOfElements(Data<WebElementList> data) {
        return getAmount("getCountOfElements", data, SeleniumFormatter::getCountOfElementsMessage, BasicPredicateFunctions::isNonNegative);
    }

    static DriverFunction<Integer> getCountOfElements(DriverFunction<WebElementList> getter) {
        return ifDriver("getCountOfElements", isNotNull(getter), SeleniumDataFunctions.isOfTypeNonEmpty(WebElement.class), getter, Driver::getCountOfElements, SeleniumDataConstants.NULL_INTEGER_NULL_DRIVER);
    }
    ...
    static DriverFunction<WebElementList> getElements(LazyLocator locator) {
        return getElementsIf(isNullLazyDataMessage(locator), getElements(Driver::getSearchContext, locator));
    }

    static DriverFunction<WebElementList> getElements(By locator) {
        return getElementsIf(CoreFormatter.isNullMessageWithName(locator, "Locator"), getElements(Driver::getSearchContext, getLazyLocator(locator)));
    }
    ...
    static DriverFunction<WebElement> getElement(LazyLocator locator) {
        return ifDriver("getElement", SeleniumFormatter.isNullLazyDataMessage(locator), getElementFromSingle(getSingleElementList(locator)), SeleniumDataConstants.NULL_ELEMENT);
    }
        ...
        return ifDriver(
            ...
            driver -> {
                ...
                if (isInvalidOrFalse(element)) {
                    return replaceMessage(SeleniumDataConstants.NULL_LIST, "Failed, nested com.github.karsaii.selenium.element issue - sublist length(" + locators.initials().size() + "): " + element.message);
                }
    ...
    static <T> DriverFunction<ExternalElementData> getLazyElementByExternal(LazyElement element, ExternalSelectorData externalData, Map<String, DecoratedList<SelectorKeySpecificityData>> typeKeys) {
        ...
        return ifDriver(
            nameof,
            SeleniumFormatter.getExternalSelectorDataErrorMessage(element, externalData, nameof),
            driver -> {
                ...
                for(; index < length; ++index) {
                    ...
                    if (isBlank(selector.object)) {
                        appendMessage(message, "Empty com.github.karsaii.selenium.selector returned, attempt: " + index + CoreFormatterConstants.END_LINE);
                        continue;
                    }

                    locator = new LazyLocator(selector.object, selectorType);
                    parameterKey = SeleniumFormatter.getUniqueGeneratedName(selectorType);
                ...
                return isNotNullWebElement(currentElement) ? (
                    DataFactoryFunctions.getWithNameAndMessage(new ExternalElementData(typeKeys, currentElement), true, nameof, "External function yielded an com.github.karsaii.selenium.element" + CoreFormatterConstants.END_LINE)
    ...
    static <T> Data<Integer> getNextCachedKey(Map<String, T> parameterMap, Iterator<String> getOrder, Map<String, DecoratedList<SelectorKeySpecificityData>> typeKeys, int parameterIndex) {
        ...
        ) : replaceMessage(CoreDataConstants.NULL_INTEGER, nameof, "The parameter map didn't contain an indexed com.github.karsaii.selenium.selector-type it should have" + CoreFormatterConstants.END_LINE));
    }
    ...
    static Data<Integer> getNextKey(DecoratedList<String> keys, int parameterIndex) {
        ...
        ) : replaceMessage(CoreDataConstants.NULL_INTEGER, "getNextKey", "The parameter map didn't contain an indexed com.github.karsaii.selenium.selector-type it should have" + CoreFormatterConstants.END_LINE);
    }
    ...
    static <T> DriverFunction<WebElement> getLazyElement(LazyElementWithOptionsData data) {
        ...
        return ifDriver(
            nameof,
            SeleniumFormatter.getLazyElementWithOptionsMessage(data, nameof),
            driver -> {
                ...
                return cacheNonNullAndNotFalseLazyElement(
                    ...
                    isBlank(SeleniumFormatter.getExternalSelectorDataMessage(externalData)) ? getLazyElementByExternal(dataElement, externalData, typeKeys).apply(driver) : SeleniumDataConstants.NULL_EXTERNAL_ELEMENT
                );
            },
            SeleniumDataConstants.NULL_ELEMENT
        );
