...
public class MethodGetCommonParametersData {
    public final HashMap<String, MethodData> methodMap;
    public final List<Method> list;
    public final Data<MethodData> defaultValue;

    public MethodGetCommonParametersData(HashMap<String, MethodData> methodMap, List<Method> list, Data<MethodData> defaultValue) {
    ...
    public boolean equals(Object o) {
        ...
        final var that = (MethodGetCommonParametersData) o;
