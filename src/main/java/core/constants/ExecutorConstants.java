...
public abstract class ExecutorConstants {
    ...
    public static final ExecuteParametersData DEFAULT_EXECUTION_DATA = new ExecuteParametersData(ExecutorConstants.DEFAULT_RANGE, Executor::returnStatus, Executor::reduceMessage, Formatter::getExecutionEndMessage);
